    ...
    <form ng-submit="add()" class="ui form">
        <div class="ui grid">
            <div class="thirteen wide column">
                ...
                <div class="ui field">
                    <textarea placeholder="Describe your idea..., markdown is allowed"
                              ng-model="model.newIdea.description" rows="3"></textarea>
                </div>
            </div>
...
<script type="text/javascript" src="libs/showdown/compressed/Showdown.min.js"></script>
